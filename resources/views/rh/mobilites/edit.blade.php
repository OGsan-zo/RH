...
@section('title', 'Modifier Mobilité')
@section('page-title', 'Modifier Mobilité')
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Modifier Mobilité</h3>
        </div>
        <form action="{{ route('mobilites.update', $mobilite->id) }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('type_mobilite_id') is-invalid @enderror" id="type_mobilite_id" name="type_mobilite_id" required>
                                ...
                                @foreach($types as $type)
                                    <option value="{{ $type->id }}" {{ old('type_mobilite_id', $mobilite->type_mobilite_id) == $type->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('ancien_departement_id') is-invalid @enderror" id="ancien_departement_id" name="ancien_departement_id">
                                ...
                                @foreach($departements as $dept)
                                    <option value="{{ $dept->id }}" {{ old('ancien_departement_id', $mobilite->ancien_departement_id) == $dept->id ? 'selected' : '' }}>
                                        {{ $dept->nom }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('nouveau_departement_id') is-invalid @enderror" id="nouveau_departement_id" name="nouveau_departement_id">
                                <option value="">-- Sélectionner --</option>
                                @foreach($departements as $dept)
                                    <option value="{{ $dept->id }}" {{ old('nouveau_departement_id', $mobilite->nouveau_departement_id) == $dept->id ? 'selected' : '' }}>
                                        {{ $dept->nom }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('ancien_poste_id') is-invalid @enderror" id="ancien_poste_id" name="ancien_poste_id">
                                ...
                                @foreach($postes as $poste)
                                    <option value="{{ $poste->id }}" {{ old('ancien_poste_id', $mobilite->ancien_poste_id) == $poste->id ? 'selected' : '' }}>
                                        {{ $poste->titre }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('nouveau_poste_id') is-invalid @enderror" id="nouveau_poste_id" name="nouveau_poste_id">
                                <option value="">-- Sélectionner --</option>
                                @foreach($postes as $poste)
                                    <option value="{{ $poste->id }}" {{ old('nouveau_poste_id', $mobilite->nouveau_poste_id) == $poste->id ? 'selected' : '' }}>
                                        {{ $poste->titre }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('date_demande') is-invalid @enderror" id="date_demande" name="date_demande" value="{{ old('date_demande', $mobilite->date_demande) }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('date_approbation') is-invalid @enderror" id="date_approbation" name="date_approbation" value="{{ old('date_approbation', $mobilite->date_approbation) }}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('date_effet') is-invalid @enderror" id="date_effet" name="date_effet" value="{{ old('date_effet', $mobilite->date_effet) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('statut_id') is-invalid @enderror" id="statut_id" name="statut_id">
                                ...
                                @foreach($statuts as $statut)
                                    <option value="{{ $statut->id }}" {{ old('statut_id', $mobilite->statut_id) == $statut->id ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('motif') is-invalid @enderror" id="motif" name="motif" rows="3">{{ old('motif', $mobilite->motif) }}</textarea>
