...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Modifier Promotion</h3>
        </div>
        <form action="{{ route('promotions.update', $promotion->id) }}" method="POST">
            ...
            <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('ancien_poste_id') is-invalid @enderror" id="ancien_poste_id" name="ancien_poste_id">
                                ...
                                @foreach($postes as $poste)
                                    <option value="{{ $poste->id }}" {{ old('ancien_poste_id', $promotion->ancien_poste_id) == $poste->id ? 'selected' : '' }}>
                                        {{ $poste->titre }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('nouveau_poste_id') is-invalid @enderror" id="nouveau_poste_id" name="nouveau_poste_id" required>
                                <option value="">-- Sélectionner --</option>
                                @foreach($postes as $poste)
                                    <option value="{{ $poste->id }}" {{ old('nouveau_poste_id', $promotion->nouveau_poste_id) == $poste->id ? 'selected' : '' }}>
                                        {{ $poste->titre }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('ancien_salaire') is-invalid @enderror" id="ancien_salaire" name="ancien_salaire" value="{{ old('ancien_salaire', $promotion->ancien_salaire) }}" step="0.01" min="0">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('nouveau_salaire') is-invalid @enderror" id="nouveau_salaire" name="nouveau_salaire" value="{{ old('nouveau_salaire', $promotion->nouveau_salaire) }}" step="0.01" min="0" required>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('date_promotion') is-invalid @enderror" id="date_promotion" name="date_promotion" value="{{ old('date_promotion', $promotion->date_promotion) }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('date_effet') is-invalid @enderror" id="date_effet" name="date_effet" value="{{ old('date_effet', $promotion->date_effet) }}" required>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('decision_numero') is-invalid @enderror" id="decision_numero" name="decision_numero" value="{{ old('decision_numero', $promotion->decision_numero) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('motif') is-invalid @enderror" id="motif" name="motif" rows="3">{{ old('motif', $promotion->motif) }}</textarea>
