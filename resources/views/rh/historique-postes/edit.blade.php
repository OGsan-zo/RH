...
@section('title', 'Modifier Historique Poste')
@section('page-title', 'Modifier Historique Poste')
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Modifier Historique Poste</h3>
        </div>
        <form action="{{ route('historique-postes.update', $historique->id) }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('type_mouvement_id') is-invalid @enderror" id="type_mouvement_id" name="type_mouvement_id" required>
                                ...
                                @foreach($types as $type)
                                    <option value="{{ $type->id }}" {{ old('type_mouvement_id', $historique->type_mouvement_id) == $type->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('poste_id') is-invalid @enderror" id="poste_id" name="poste_id">
                                ...
                                @foreach($postes as $poste)
                                    <option value="{{ $poste->id }}" {{ old('poste_id', $historique->poste_id) == $poste->id ? 'selected' : '' }}>
                                        {{ $poste->titre }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('titre_poste') is-invalid @enderror" id="titre_poste" name="titre_poste" value="{{ old('titre_poste', $historique->titre_poste) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('departement_id') is-invalid @enderror" id="departement_id" name="departement_id">
                                ...
                                @foreach($departements as $dept)
                                    <option value="{{ $dept->id }}" {{ old('departement_id', $historique->departement_id) == $dept->id ? 'selected' : '' }}>
                                        {{ $dept->nom }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('salaire') is-invalid @enderror" id="salaire" name="salaire" value="{{ old('salaire', $historique->salaire) }}" step="0.01" min="0">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('date_debut') is-invalid @enderror" id="date_debut" name="date_debut" value="{{ old('date_debut', $historique->date_debut) }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('date_fin') is-invalid @enderror" id="date_fin" name="date_fin" value="{{ old('date_fin', $historique->date_fin) }}">
